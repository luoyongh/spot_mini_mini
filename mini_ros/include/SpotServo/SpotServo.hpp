...
public:
    ...
    /// \param servo_num: pin number on PCA9685, from 1 to 16, 17 to 32, etc.
    ...
    void Initialize(const int & servo_num_, const double & stand_angle_, const double & home_angle_, const double & offset_, const LegType & leg_type_, const JointType & joint_type_,
...
private:
    // servo number on PCA9685, from 1 to 16 on board 1, 17 to 32 on board 2, etc.
    int servo_num = -1;
